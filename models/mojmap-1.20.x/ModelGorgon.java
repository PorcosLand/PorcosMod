	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 37)
						...
						.addBox(9.0F, -36.0F, -5.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(90, 60)
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-2.0F, 3.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(108, 75)
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(110, 110)
						.addBox(-1.0F, 3.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(108, 85)
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(20, 108)
						.addBox(22.0F, 0.0F, -3.0F, 5.0F, 23.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(108, 67)
						.addBox(21.0F, 19.0F, -4.0F, 7.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(51, 3)
						.addBox(22.0F, 21.0F, -3.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(48, 0)
						.addBox(24.0F, 21.0F, -3.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(11, 44)
						.addBox(26.0F, 21.0F, -3.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(103, 47)
						.addBox(22.0F, -1.0F, -4.0F, 6.0F, 13.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-12.0F, -11.0F, -1.0F));

		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(0, 94)
						.addBox(-26.0F, 1.0F, -3.0F, 5.0F, 23.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(98, 32)
						.addBox(-27.0F, 20.0F, -4.0F, 7.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(14, 11)
						.addBox(-22.0F, 22.0F, -3.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 0)
						.addBox(-24.0F, 22.0F, -3.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-26.0F, 22.0F, -3.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 108)
						.addBox(-27.0F, 0.0F, -4.0F, 6.0F, 12.0F, 7.0F, new CubeDeformation(0.0F)),
