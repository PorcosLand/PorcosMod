 ...
 *
 */
package net.mcreator.porcoslandbosses;
...
@Mod("porcoslandbosses")
public class PorcoslandbossesMod {
	public static final Logger LOGGER = LogManager.getLogger(PorcoslandbossesMod.class);
	public static final String MODID = "porcoslandbosses";
	...
	public PorcoslandbossesMod() {
		...
		PorcoslandbossesModTabs.REGISTRY.register(bus);
