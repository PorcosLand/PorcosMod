package net.mcreator.porcosmod.client.model;
...
public class ModelTiti<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("porcosmod", "model_titi"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cuadradoPierna_r2 = RightLeg2.addOrReplaceChild("cuadradoPierna_r2", CubeListBuilder.create().texOffs(30, 0).addBox(6.0F, -6.0F, -4.0F, 2.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.7854F, 0.0F, 0.0F));
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-11.0F, -18.0F, -5.0F, 10.0F, 7.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(27, 24).addBox(2.0F, -16.0F, -4.0F, 8.0F, 6.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition rama2_r1 = Head.addOrReplaceChild("rama2_r1", CubeListBuilder.create().texOffs(28, 20).addBox(1.0F, -12.0F, -1.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
