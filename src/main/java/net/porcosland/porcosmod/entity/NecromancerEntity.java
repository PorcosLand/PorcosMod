...
public class NecromancerEntity extends Monster {
	public NecromancerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PorcosmodModEntities.NIGROMANTE.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(PorcosmodModEntities.NIGROMANTE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
