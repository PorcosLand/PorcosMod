...
import net.porcosland.porcosmod.procedures.RadagonOnInitialEntitySpawnProcedure;
...
public class RadagonEntity extends Monster {
	...
	public RadagonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PorcosmodModEntities.RADAGON.get(), world);
	}

	public RadagonEntity(EntityType<RadagonEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("Radagon de la Orden Dorada"));
